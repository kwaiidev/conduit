...
class HandDetectionApp:
    def __init__(self, window, window_title):
        ...
        # Add a Reset button to clear all text
        self.btn_reset = Button(button_frame, text="Reset", width=12, font=("Arial", 14), bg="#9C27B0", fg="white",
                                command=self.reset_sentence)
        self.btn_reset.grid(row=1, column=2, padx=10, pady=10)
    ...
    def reset_sentence(self):
        """Reset/clear the entire sentence."""
        self.sentence = ""
